using System.Data.SqlClient; // !!!Usar esta y no la de Microsoft.Data.SqlClient porque no es lo mismo(Da error de certificados con este ejemplo)!!!!

namespace Libreria
{
    public abstract class DB // despues la vamos a hacer abtracta
    {
